...
""" # load data
pmaxs = np.load('tfg_13_pmaxs3.npy')
frabis = np.load('tfg_13_frabis3.npy') """
# save data
np.save('tfg_13_pmaxs3', pmaxs)
np.save('tfg_13_frabis3', frabis)
...
with plt.style.context('science'):
    ...
    plt.plot(f2s, pmaxs, linewidth=1.5)
    plt.savefig('Probs_w2.png')
    ...
    plt.plot(f2s, frabis*1000, linewidth=1.5)
